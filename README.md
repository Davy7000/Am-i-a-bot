...
<h1 style="font-family:'Orbitron', monospace; color:'aqua'; animation:scroll 8s linear infinite; white-space:nowrap;">㊝모ＡＩＭＢＯＴ？？？☯︎
</h1>

<img src="https://files.catbox.moe/rubewq.jpg" width="160" style="border-radius:20px; box-shadow:0 0 40px #00ffea;" />
...
## <a name="panel-setup" href='#tlm'>💻Panel Deployment Guide</a>
...
### Project Owner: 𝑻𝒘𝒊𝒍𝒊𝒈𝒉𝒕_𝑲𝒊𝒏𝒈☯❥
<a href='https://wa.me/+242050336960?text=*_Hello+𝑻𝒘𝒊𝒍𝒊𝒈𝒉𝒕_𝑲𝒊𝒏𝒈☯❥_*' target="_blank">
...
<h2 id='tlm'>Télécharger le <a href=''>fichier.zip</a></h2>
